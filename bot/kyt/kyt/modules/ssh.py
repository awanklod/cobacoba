...
async def create_ssh(event):
	async def create_ssh_(event):
	    ...
	    async with bot.conversation(chat) as limit:
			await event.respond("**Limit IP:**")
			limit = limit.wait_event(events.NewMessage(incoming=True, from_users=sender.id))
			limit = (await limit).raw_text
...
[Button.inline(" MEMBER USER SSH ","show-ssh"),
